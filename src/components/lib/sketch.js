/*!
 * Project: p5-react https://github.com/JobLeonard/p5-react
 * License (LGPL-2.1) https://github.com/JobLeonard/p5-react/blob/master/LICENSE
 */
...
class SketchComponent extends PureComponent {
  ...
  mountedView(view) {
    if (view) {
      // Next line is modified with respect to original script
      const ratio = 1;
