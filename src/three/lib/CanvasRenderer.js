...
var CanvasRenderer = function(parameters) {
  ...
  this.setClearColorHex = function(hex, alpha) {
    console.warn(
      'CanvasRenderer: .setClearColorHex() is being removed. Use .setClearColor() instead.'
    );
  ...
  this.render = function(scene, camera) {
    if (camera.isCamera === undefined) {
      console.error(
        'CanvasRenderer.render: camera is not an instance of Camera.'
      );
      return;
    }
...
export { SpriteCanvasMaterial, CanvasRenderer };
